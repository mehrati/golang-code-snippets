...
func main() {
	ArrayColor := []AnsiColorCode{ColorBlack,
		ColorRed, ColorGreen, ColorYellow,ColorGray,
		ColorBlue, ColorPurple, ColorCyan,ColorLightWhite,
		ColorWhite, ColorLightBlack, ColorLightRed,
		ColorLightGreen, ColorLightYellow, ColorLightBlue,
		ColorLightPurple, ColorLightCyan, }
	for _,j:= range ArrayColor {
		fmt.Printf("\r %s ",j.Apply("Hello World !!!"))
